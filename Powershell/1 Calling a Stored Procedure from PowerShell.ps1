...
$results = Invoke-Sqlcmd -ServerInstance localhost -Database AdventureWorks2017 -Query "uspGetBillOfMaterials"
...
$results = Invoke-Sqlcmd -ServerInstance localhost -Database AdventureWorks2017 -Query "[dbo].[uspGetBillOfMaterials] @StartProductID = $productid, @CheckDate = '$checkdate'"
